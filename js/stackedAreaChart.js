...
StackedAreaChart.prototype.updateVis = function(){
    ...
    categories
        .style("fill", function(d) {
            if(d.name == "Eating and drinking places") { return "#0868ac"; }
            else if(d.name == "Hotels and motels") {return "#7bccc4"; }
            else if(d.name == "Retail stores, direct selling") {return "#ccebc5";}
            else if(d.name == "Recreational places") {return "#43a2ca";}
            else if(d.name == "Schools and colleges") {return "#f0f9e8";}
            else if(d.name == "All other") {return "#a8ddb5";}
        })
        .attr("d", function(d) {
            if(vis.filter)
